#
#  Be sure to run `pod spec lint RTPageControl-ios.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
RTPageControl is simple UIKit-control written in swift.
                   DESC
  ...
  s.source       = { :git => "https://github.com/RuntimeLLC/RTPageControl-ios.git", :tag => "#{s.version}" }
